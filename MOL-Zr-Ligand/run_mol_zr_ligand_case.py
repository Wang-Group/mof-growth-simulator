...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Run a MOL case from the normal code baseline, optionally enabling "
            "a prebound Zr-BTB branch derived from the existing KC chemistry."
        )
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'multisite_first_binding_only' for the 12-site/3-site model."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Leave at 0 to keep only the 1:1 prebound Zr-BTB species."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output-root",
        default="output/mol_zr_ligand_cases",
        help="Parent directory that will receive the timestamped run folder.",
    )
    parser.add_argument(
        "--template",
        default="MOL_growth_main_20250811.py",
...
def main():
    ...
    print("Running MOL Zr-Ligand case with config:")
