...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate a standalone multisite Zr-AA/BTB exchange equilibrium with "
            "12 cluster sites and 3 linker sites, without any follow-up reactions."
        )
    )
    ...
    parser.add_argument(
        "--output-root",
        default="output/mol_multisite_exchange_cases",
