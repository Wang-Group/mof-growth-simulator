...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Run distorted/prebound MOL trajectories until a target entity count "
    ...
    parser.add_argument("--output-root", default="output/mol_distorted_time_to_target")
...
def run_case(job):
    ...
    for step in range(int(job["max_steps"])):
        ...
        flag, selected_carboxylate, total_growth_rate, selected_pair, addition_mode = assembly.next_thing_to_do(
            ...
            external_addition_activity=case_inputs["total_external_addition_channel_activity"],
            free_zr6_addition_activity=case_inputs["free_zr6_addition_activity"],
            free_linker_addition_activity=case_inputs["free_linker_addition_activity"],
            prebound_zr_btb_addition_activity=case_inputs["prebound_zr_btb_addition_activity"],
        )
        ...
        if flag == 0:
            ...
            assembly.grow_one_step(selected_carboxylate, addition_mode=addition_mode)
        elif flag == -1:
    ...
    return {
        ...
        "total_external_addition_channel_activity": case_inputs["total_external_addition_channel_activity"],
        "legacy_external_addition_activity": case_inputs["legacy_external_addition_activity"],
        "free_zr6_addition_activity": case_inputs["free_zr6_addition_activity"],
        "free_linker_addition_activity": case_inputs["free_linker_addition_activity"],
        "prebound_zr_btb_addition_activity": case_inputs["prebound_zr_btb_addition_activity"],
        "external_channel_activity_basis": case_inputs["external_channel_activity_basis"],
        "prebound_external_channel_species": case_inputs["prebound_external_channel_species"],
...
def write_per_run_csv(rows, output_path):
    fieldnames = [
        ...
        "total_external_addition_channel_activity",
        "legacy_external_addition_activity",
        "free_zr6_addition_activity",
        "free_linker_addition_activity",
        "prebound_zr_btb_addition_activity",
        "external_channel_activity_basis",
    ...
    with ProcessPoolExecutor(max_workers=max(1, int(args.workers))) as executor:
        ...
        for future in as_completed(future_to_job):
            ...
            print(
                ...
                f"reached_target={row['reached_target']} time={row['time_to_target_seconds']}"
            )
