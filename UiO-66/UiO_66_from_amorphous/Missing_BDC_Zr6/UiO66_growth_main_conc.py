...
entropy_table_size = 25000
if max_entities is not None and max_entities > 0:
    entropy_table_size = max(entropy_table_size, int(max_entities) + 5)
Entropy_correction_table = [entropy_assembly(ENTROPY_GAIN, i) for i in range(entropy_table_size)]
