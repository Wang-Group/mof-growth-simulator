...
def compute_multisite_exchange_state(
    ...
    return {
        ...
        "assumptions": [
            ...
            "A free linker contributes two equivalent first-binding sites by default.",
            "Once a linker binds through one end, the second linker end is not allowed to react further in this model.",
