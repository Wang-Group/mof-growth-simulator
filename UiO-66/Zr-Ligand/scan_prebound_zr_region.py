...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Run a replicated Zr scan for the updated prebound Zr-BDC model and "
    ...
    parser.add_argument("--output-root", default="output/prebound_zr_region_scan")
...
def build_plot(summary_lookup, zr_values, targets, output_path):
    ...
    max_entities_ax.set_title("Updated prebound Zr-BDC model: growth suppression vs Zr")
